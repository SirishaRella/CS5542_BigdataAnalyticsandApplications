...
def read_NewsGroup_data(similarity):    
    categories_3NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns', 'rec.sport.baseball', 'rec.sport.hockey']
