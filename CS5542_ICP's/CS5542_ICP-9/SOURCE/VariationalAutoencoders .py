...
def train(network_architecture, learning_rate=0.003,
...
vae, epoch_cost = train(network_architecture, training_epochs=10) 
x_sample = mnist.test.next_batch(100)[0]
x_reconstruct = vae.reconstruct(x_sample)
train_epochs = 10

#plotting the reconstruction cost
x = np.arange(0,train_epochs,1)
plt.title("Cost Graph")
plt.plot(x,epoch_cost)
plt.show()
...
vae_2d,epoch_cost = train(network_architecture, training_epochs=10)
