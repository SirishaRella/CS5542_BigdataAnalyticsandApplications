...
dataset_number = '1'
video_file_name = 'test_data/video/' + dataset_number + '.mp4'
youtube_captions_file_name = 'test_data/youtube_captions/' + dataset_number + '.txt'
captions_file_name = 'test_data/captions/' + dataset_number + '.txt'
image_frame_directory = 'test_data/image_frames/' + dataset_number + '/'
